  ...
  <div class="login__logo login__gridItem">
    ...
    <h1>BUENA MUCHACHA</h1>
      <form id="loginForm" class="login__form login__gridItem">
        ...
        <spam class="login_displayNone" id="loginEmailInvalido">Este correo no está registrado</spam>
        <spam class="login_displayNone" id="loginEmailNull">Ingrese un correo válido</spam>
        ...
        <button id="ingreso_login" class="login__buttonLogin" type="submit" role="link">Iniciar Sesión</button>
        <p>o</p>
